...
def applied_guesses():
    while True:
        guess = int(input("guess a number between " + str(lowest_number) + " and " + str(highest_number) + ": "))
        if lowest_number <= guess <= highest_number:
            return guess
        elif lowest_number > guess > highest_number:
            print(("invalid guess, make sure guess is within " ) + str(lowest_number) + " and " + str(highest_number) + ": ")
        else:
...
def play_number_guesser():
    ...
    if not won:
        print("No more guesses left, the number was " + str(random_number))
